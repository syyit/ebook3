...
function zoomCorner(isLeft, isTop) {
    ...
    if ($('.canvasObj')[0] != undefined) {
        ...
        for (var num = 0; num < $('.canvasObj').length; num++) {
            ...
            var top = (Number($($('.canvasObj')[num]).attr('top')) - MainObj.CanvasT) * 2;
            ...
            if ($('.canvasObj')[num] == $('.Text')[0]) {
                ...
                if ($('.canvasObj')[num].type == 'text') {
                    ...
                    $($('.canvasObj')[num]).css({
                        'width': $($('.canvasObj')[num]).attr('width') * 2,
                        'height': $($('.canvasObj')[num]).attr('height') * 2,
                        'left': left,
                        'top': top
                    })
                    ...
                    $($('.canvasObj')[num]).css({
                        'width': $('.canvasObj')[num].width * 2,
                        'height': $('.canvasObj')[num].height * 2,
                        'left': left,
                        'top': top
                    })

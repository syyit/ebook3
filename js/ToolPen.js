...
function upComment(canvas) {
    ...
    $(textDiv).append(
        '<div class=\"commentBtns\"><img class=\"commentNarrow\" onClick=\"commentNarrow(\'' + newCxt.canvas.id + '\')\" src=\"ToolBar/txtnarrow.png\"><img class=\"commentClose\" onClick=\"commentClose(\'' + newCxt.canvas.id + '\')\" src=\"ToolBar/txtclose.png\"></div>'
    );
